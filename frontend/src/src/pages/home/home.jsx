    ...
    return (
        ...
        <div className="flex flex-row w-full h-[100vh] items-center p-[0]">
            <div className="flex flex-col w-3/5 h-full bg-[color:var(--primary)] justify-center items-center gap-4">
                ...
                <p className="w-3/4 text-[25px] leading-relaxed text-center">Welcome to our all-in-one learning hub, <br /> where knowledge meets convenience. <br /> Let the journey towards knowledge and success begin!</p>
            </div>
            <div className="flex flex-col w-2/5 h-full items-center justify-center gap-4 p-10 flex-wrap">
                ...
                <p className="text-white text-center">POWERED BY CHATGPT</p>
                </div>
            </div>
        </div>
        </main>
